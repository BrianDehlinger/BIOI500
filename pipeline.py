...
if __name__ == '__main__':
    ...
    for genome in genome_file_paths[0:2]:
        ...
        os.system(f'singularity exec singularity_images/ncbi-amrfinderplus-3.6.15--hf18293b_0.simg amrfinder -n {genomes_directory}/{genome} -O {amr_finder_organism} -o {output_directory}/{genome}/amrfinder/amrfinderoutput.txt --threads 17')
